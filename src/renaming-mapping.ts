...
export const STDLIB_RENAMING: { [name in string]: string } = {
  ...
  'parse_std_addr': 'getWorkchainAndHash',
  ...
  'get_forward_fee': 'calculateForwardFee',
  'get_simple_forward_fee': 'calculateForwardFeeWithoutLumpPrice',
  'get_original_fwd_fee': 'calculateOriginalForwardFee',
  'is_address_none': 'isNone',
...
export const STDLIB_AUTO_IMPORTS: { [name in string]: string } = {
  ...
  'calculateForwardFee': '@stdlib/gas-payments',
  'calculateForwardFeeWithoutLumpPrice': '@stdlib/gas-payments',
  'calculateOriginalForwardFee': '@stdlib/gas-payments',
